...
vim.api.nvim_set_keymap('n', '<silent>', '<esc><esc> :nohlsearch<CR><esc>', {noremap = true})
...
vim.api.nvim_set_keymap('n', '<Leader>Y', '"+y', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>P', '"+p', {noremap = true})
vim.api.nvim_set_keymap('n', '<leader>h', ':YankHistoryRgPaste<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<c-n>', '<plug>(YoinkPostPasteSwapBack)', {noremap = true})
vim.api.nvim_set_keymap('n', '<c-p>', '<plug>(YoinkPostPasteSwapForward)', {noremap = true})
-- vim.api.nvim_set_keymap('n', 'p', '<plug>(YoinkPaste_p)', {noremap = true})
-- vim.api.nvim_set_keymap('n', 'P', '<plug>(YoinkPaste_P)', {noremap = true})
vim.api.nvim_set_keymap('n', '<leader>t', ':20sp term://zsh<CR>', {noremap = true})
